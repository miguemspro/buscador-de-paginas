      ...
      <div className="max-w-lg w-full space-y-6">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="p-6 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 animate-pulse">
              <Upload className="h-12 w-12 text-primary" />
            </div>
            
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">Arraste o print do Salesforce</h2>
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent text-accent-foreground font-medium">
          ...
          {[
            ...
            >
              ...
              <div className="text-center">
                <div className="text-xs text-muted-foreground">Passo {item.step}</div>
